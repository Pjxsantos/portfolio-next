...
const AboutSection = () => {
  ...
  return (
    <section className="text-white" id="about">
      <div className="md:grid md:grid-cols-2 gap-8 items-center sm:border-[#33353F] sm:border rounded-md  py-8 px-16 flex flex-col sm:flex-row xl:gap-16 sm:py-16 xl:px-16">
